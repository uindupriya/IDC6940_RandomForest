...
::: {#left-side style="font-size: 32px; line-height: 1.4; width: 38%;"}
...
:::
::: {.column width="25%"}
**Normalization on Chest EDA and TEMP** ![Normalization comparison chest](wesad_chest_normalization_comparison.png){fig-align="center" width="70%"}
![Normalization comparison wrist](wesad_wrist_normalization_comparison.png){fig-align="center" width="70%"}
::: 
```{=html}
