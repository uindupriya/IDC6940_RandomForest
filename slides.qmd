...
::: {.column width="45%" style="font-size: 20px; line-height: 1.0;"}
**Dataset Overview**
...
::: {.column width="45%"}
![](wesad_chest_window_pairplot_1min.png){fig-align="center" width="70%"}

![](wesad_chest_window_pairplot_3min.png){fig-align="center" width="70%"}
:::
