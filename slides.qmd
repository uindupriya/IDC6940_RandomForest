...
<div style="text-align:center; margin-top:35vh; font-size:2.2em; font-weight:400;">
...
- Systematic review: EDA is a strong sympathetic nervous system (SNS) stress-state indicator — but only *one part* of the picture
...
* **EDA:** Reflects sympathetic nervous system response
...
- **Dual Window Strategy:** 
    ...
    - **3-minute window:** engineered to filter out momentary noise and capture sustained physiological stress-response trends.
...
<div style="text-align:center; margin-top:35vh; font-size:2.2em; font-weight:400;">
ARIMA-based vs Random Forest Classification Results
</div>
