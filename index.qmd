...
*Label (target variable)* : Label (target variable): The categorical outcome variable coded 1 = Neutral (Baseline), 2 = Stress, 3 = Amusement, as defined by the WESAD protocol (Schmidt and Reiss 2018). This is the variable both models ultimately predict — directly for Random Forest, and after converting a continuous forecast into a category for ARIMA.
