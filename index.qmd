...
Table 1 presents descriptive statistics for the four physiological 
signals across the three stress conditions. EDA shows the most notable 
difference across conditions, with mean EDA rising from 3.43 during 
Neutral to 4.79 during Stress — a 40% increase — confirming 
electrodermal activity as a reliable stress indicator [@ziyadidegan2025]. 
RESP also shows higher variability during Stress (std = 3.57) compared 
to Neutral (std = 2.08), suggesting irregular breathing patterns under 
stress. ECG mean values remain consistent across conditions but show 
slightly higher standard deviation during Stress (0.252 vs 0.227), 
reflecting increased heart rate variability. TEMP shows minimal 
