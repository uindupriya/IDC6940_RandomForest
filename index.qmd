...
RESULT: ![Normalization comparison](wesad_wrist_normalization_comparison.png)
...
RESULT: ![Wrist window rolling](wesad_wrist_rolling_scatter.png)
...
*Table 2: Random Forest chest sensor classification results using 
...
*Table 3: Random Forest wrist sensor classification results using 
rolling window features (EDA, TEMP at 4Hz).*

#### RF Results

RESULT: ![ROC Curves on RF](rf_roc_curves_combined.png)
RESULT: ![RF Confusion matrix](RF_global_confusion_matrix.png)
